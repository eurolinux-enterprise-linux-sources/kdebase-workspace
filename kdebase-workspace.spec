...
# fix kdm crash, fastrack bz#649345
Patch56: kdebase-workspace-4.3.4-kdm-bz649345.patch

# fix ksysguard crash, fastrack bz#639359
Patch57: kdebase-workspace-4.3.4-ksysguard-bz#639359.patch

# gnome/kde system monitor tool uses same icon, fastrack bz#587917
# rename utilities-system-monitor to kde-utilities-system-monitor
Patch58: kdebase-workspace-4.3.4-bz#587917-icons.patch

# set graphicsystem to native for plasma-desktop
# bz#1098949, bz#1070371
Patch59: kdebase-workspace-4.3.4-graphicssystem-bz#1098949.patch

# bz#1036568
Patch60: kdebase-workspace-rhbz#1043480-kwin-reposition-ofscreen-windows.patch

# 4.3 branch
Patch100: kdebase-workspace-4.3.5.patch

# 4.4 branch, backport fixes
...
# bz#749460, taskbar entries randomly rearranged after desktop change
Patch202: kdebase-workspace-4.3.4-bz#749460.patch

# bz#1143971, PowerDevil Error - The profile "" has been selected, but it does not exist
Patch203: kdebase-workspace-4.3.4-powerdevil.patch
...
%patch56 -p1 -b .bz#649345
%patch57 -p1 -b .bz#639359
%patch58 -p1 -b .bz#587917
%patch59 -p1 -b .graphicssystem
%patch60 -p1 -b .kwin-reposition-offscreen-windows
...
# add symlinks plasma-desktop, kde apps still search help from here
(cd %{buildroot}%{_kde4_docdir}/HTML/en; ln -s plasma plasma-desktop)

# rename utilities-system-monitor to kde-utilities-system-monitor
for i in 16x16 22x22 32x32 48x48 64x64 128x128 ; do
  pushd %{buildroot}%{_kde4_iconsdir}/hicolor/$i/apps
  ln -s ../../../oxygen/$i/apps/utilities-system-monitor.png kde-utilities-system-monitor.png
  popd
done
...
* Mon Jan 19 2015 Than Ngo <than@redhat.com> - 4.3.4-29
- Resolves: bz#1143971, the profile "" has been selected, but it does not exist

* Tue Jun 17 2014 Than Ngo <than@redhat.com> - 4.3.4-28
- rebuild against new libxml2

* Mon Jun 02 2014 Than Ngo <than@redhat.com> - 4.3.4-27
- fix description

* Wed May 28 2014 Daniel Vrátil <dvratil@redhat.com> - 4.3.4-26
- Resolves: bz#1036568, don't leave windows offscreen after deatching ext. monitor

* Tue Mar 11 2014 Than Ngo <than@redhat.com> 4.3.4-25
- fix plasma-desktop crash

* Fri Aug 24 2012 Than Ngo <than@redhat.com> - 4.3.4-24
- Resolves: bz#749460, taskbar entries randomly rearranged after desktop change

* Thu Feb 09 2012 Than Ngo <than@redhat.com> - 4.3.4-23
- Resolves: bz#724960, remove the unsupported dependency

* Mon Jul 18 2011 Than Ngo <than@redhat.com> - 4.3.4-22
- Resolves: bz#666295, Missing help page(s) for Plasma workspace
- Resolves: bz#587917, gnome/kde system monitor tool use same icon

* Fri Jul 15 2011 Than Ngo <than@redhat.com> - 4.3.4-21
- Resolves: bz#639359, fix ksysguard crash

* Wed Jul 06 2011 Than Ngo <than@redhat.com> - 4.3.4-20
- Resolves: bz#649345, fix kdm crash
